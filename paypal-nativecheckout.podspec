...
# s.source       = { :git => "git@github.com:paypal/paypalcheckout-ios.git", :tag => "1.0.2" }

s.source       = { :git => "https://github.paypal.com/pvenkatakrishnan/paypalcheckout-ios.git", :tag => "1.0.2" }
